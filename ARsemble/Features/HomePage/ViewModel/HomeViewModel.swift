...
final class HomeViewModel {
    ...
    static let sample: [HomeModel] = [
        HomeModel(lessonNumber: 1, title: "Center of Gravity", imageName: "level1", levelCount: 10),
        HomeModel(lessonNumber: 2, title: "Friction",          imageName: "level1", levelCount: 10),
        HomeModel(lessonNumber: 3, title: "Momentum",          imageName: "level1", levelCount: 10)
    ]
}
